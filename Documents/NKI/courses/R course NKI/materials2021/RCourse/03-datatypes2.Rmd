...
There are many chunck options available, most common being `echo`, `eval`. For example the option results='hide' prevents the result of the `x + 10` being included in the compiled report:  
...
When referring to nonexisting elements, the result is `NULL` 
